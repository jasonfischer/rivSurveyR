...
```{r, UTM_Plot, fig.show='hold', echo=FALSE, out.width='3.5in', out.height='3.5in'}
...
```{r, spatialAvgPlanformPlots, fig.show='hold', fig.height=7, fig.width=7, echo=FALSE, out.height='3.5in'}
...
```{r, xSecPlot2, fig.show='hold', echo=FALSE, out.width='3.5in', out.height='3.5in'}
...
```{r, xSecPlot3, fig.show='hold', echo=FALSE, out.width='3.5in', out.height='3.5in'}
...
```{r, planform_plot_defaults, fig.show='hold', fig.height=7, fig.width=7, out.width='3.5in', out.height='3.5in'}
...
```{r, planform_plot_units, fig.show='hold', fig.height=7, fig.width=7, out.width='3.5in', out.height='3.5in'}
...
```{r, planform_interpolate, fig.show='hold', fig.width=7, fig.height=7, out.widht='3.5in', out.height='3.5in'}
...
```{r, planform_interpolate_overlay, fig.width=7, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, secondary_plot, fig.width=8, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, secondary_plot_2, fig.show='hold', fig.width=8, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, secondary_plot_3, fig.show='hold', fig.width=8, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, secondary_plot_4, fig.width=8, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, secondary_plot_5, fig.show='hold', fig.width=8, fig.height=7, out.width='3.5in', out.height='3.5in'}
...
```{r, orthogonal_proj, fig.show='hold', out.width='3.5in', out.height='3.5in'}
...
```{r, proj_transect, fig.show='hold', out.width='3.5in', out.height='3.5in'}
...
```{r, proj_transect_wrong, fig.show='hold', out.width='3.5in', out.height='3.5in'}
...
```{r, blueToRedColors, fig.show='hold', out.width='3.5in', out.height='3.5in'}
jet.colors(10)
...
U.S. Geological Survey (USGS) Computer Program rivSurveyR version 2.0. Written by Jason L. Fischer, USGS - Great Lakes Science Center, Ann Arbor, Michigan, USA. Written in programming language R (R Core Team, 2014, www.R-project.org), version 3.2.4 (2016-03-16). Run on a PC with Intel(R) Core(TM) i5 CPU, 2.40 GHz processor, 8.0 GB RAM, and Microsoft Windows 7 Enterprise operating system 2009 Service Pack 1. Source code is available from Jason L. Fischer on GitHub, jfischer@usgs.gov.
