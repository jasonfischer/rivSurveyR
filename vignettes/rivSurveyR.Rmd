...
This compiles the transects using the default settings, where layer averaged velocities correspond to the average velocity within the depth bounds of the ADCP measurements and data is projected to a mean transect line. However, if there is interest in water velocities within a meter from the bottom, setting the layerReference to "bottom" defines the bounds of x1 and x2 as the distance from the bottom. Setting x1 = 1 and keeping x2 = "minimum" ensures that the layer averaged velocities is the average of the velocities measured between the bottom and 1 meter off the bottom.

```{r, compile_ADCP2, results='hide', warning=FALSE}
planform <- xSec.planform(mNine, tNames, "bottom", 1, "minimum")
```
...
mean.planform.alt <- average.planform(mNine, tNames, layerReference="bottom", x1=1, x2="minimum")
...
sd.planform <- average.planform(mNine, tNames, FUN = sd, layerReference="bottom", x1=1,
                                x2="minimum")
```
...
mean.planform.meter <- average.planform(mNine, tNames, binWidth=1, layerReference="bottom", x1=1,
                                        x2="minimum")
nrow(mean.planform.meter)
mean.planform.fiveMeter <- average.planform(mNine, tNames, binWidth=5, layerReference="bottom",
                                            x1=1, x2="minimum")
...
planform.ADCP <- process.planform(mNine, tNames, layerReference="bottom", x1=1, x2="minimum", 
